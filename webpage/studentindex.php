...
<body class="bg-steel">
    <div class="app-bar fixed-top darcula" data-role="appbar">
        <a class="app-bar-element branding">UniClick</a>
            ...
            <div class="row" style="height: 100%">
                <div class="cell size-x200" id="cell-sidebar" style="background-color: #71b1d1; height: 100%">
                    <ul class="sidebar">
                        ...
                        <li><a href="#">
                            <span class="mif-books icon"></span>
                            <span class="title">Session 2/27/2017</span>
                        </a></li>
                        <li class="active"><a href="#">
                            <span class="mif-books icon"></span>
                            <span class="title">Session 3/6/2017 </span>
                        </a></li>
                    </ul>
                </div>
                <div class="cell auto-size padding20 bg-white" id="cell-content">
                    <h1 class="text-light">Class 1 - Session 3/6/2017 <span class="mif-books place-right"></span></h1>
                    ...
                    <table class="dataTable border bordered" data-role="datatable" data-auto-width="false">
                        ...
                        <tr>
                            ...
                            <td class="sortable-column sort-asc" style="width: 50px">ID</td>
